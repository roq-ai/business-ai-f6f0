...
CREATE TABLE "business_idea" (
    ...
    CONSTRAINT "business_idea_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "business_idea" ADD CONSTRAINT "business_idea_startup_id_fkey" FOREIGN KEY ("startup_id") REFERENCES "startup"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
